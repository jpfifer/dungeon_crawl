...
pub const DESIRED_FLOOR: usize = NUM_TILES / 3;
...
impl DrunkardsWalkArchitect {
    pub fn drunkard(&mut self, start: &Point, rng: &mut RandomNumberGenerator, map: &mut Map) {
        ...
        loop {
            ...
            match rng.range(0, 4) {
                ...
                2 => drunkard_pos.y -= 1,
                3 => drunkard_pos.y += 1,
                _ => panic!("No clue how you got a value outside of 0 to 3"),
            }

            if !map.in_bounds(drunkard_pos) {
                map.tiles[drunk_idx] = TileType::Wall;
                break;
            }
